 ...
 * @author Hrushi
 */
public class ViewAnimalDetail extends javax.swing.JFrame {

    /**
     * Creates new form ViewAnimalDetail
     */
    public ViewAnimalDetail() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Adoption status");

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("Medical condition");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAnimalDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAnimalDetail().setVisible(true);
            }
        });
    }
